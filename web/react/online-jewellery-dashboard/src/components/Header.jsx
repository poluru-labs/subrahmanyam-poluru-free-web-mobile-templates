...
import { brand, breadcrumbs, products, orders } from '../data';
...
export function Header() {
  ...
  const results = useMemo(() => {
    ...
    const searchIndex = [...products.map((item) => ({ label: item.name, type: 'Product', to: '/catalog' })), ...orders.map((item) => ({ label: item.id, type: 'Order', to: '/orders' }))];
